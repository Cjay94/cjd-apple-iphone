...
const VideoCarousel = () => {
    ...
    const handleLoadedMetadata = (index, e) => setLoadedData((prevVideo) => [...prevVideo, e]);
            ...
            <div className="relative flex-center mt-10">
                <div className="flex-center py-5 px-7 bg-gray-300 backdrop-blur rounded-full">
                    {videoRef.current.map((_, index) => (
                        <span key={index} className="mx-2 w-3 h-3 bg-gray-200 rounded-full relative cursor-pointer"
